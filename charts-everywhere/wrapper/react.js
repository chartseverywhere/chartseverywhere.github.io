...
var DonutEverywhere = makeReacty('donut-everywhere');
var DonutDoubleEverywhere = makeReacty('donutdouble-everywhere');
var LineEverywhere = makeReacty('line-everywhere')
var BarEverywhere = makeReacty('bar-everywhere');
export const HBarEverywhere = makeReacty('hbar-everywhere');
export const BubbleEverywhere = makeReacty('bubble-everywhere');

var DonutEverywhere = makeReacty('dnx-sidebar');
var DonutDoubleEverywhere = makeReacty('dnx-button');
